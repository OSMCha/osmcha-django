...
class User(AbstractUser):
    ...
    message_good = models.TextField("Default message to good changesets", blank=True)
    message_bad = models.TextField("Default message to bad changesets", blank=True)
    comment_feature = models.BooleanField(
        "Enable suggestion to post comment", default=False
    )
