...
LOCAL_APPS = (
    "osmchadjango.users.apps.UsersConfig",  # custom users app
    "osmchadjango.changeset.apps.ChangeSetConfig",
    "osmchadjango.feature.apps.FeatureConfig",
    "osmchadjango.supervise.apps.SuperviseConfig",
    "osmchadjango.frontend.apps.FrontendConfig",
    "osmchadjango.roulette_integration.apps.RouletteIntegrationConfig",
)
